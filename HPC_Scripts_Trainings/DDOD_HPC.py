...
#
cfg = Config.fromfile('/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/config_files/ddod_r50_fpn_1x_coco.py')
...
cfg.load_from = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/checkpoints_DDOD/epoch_154.pth'

# Set up working dir to save files and logs
cfg.work_dir = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/checkpoints_DDOD/'
