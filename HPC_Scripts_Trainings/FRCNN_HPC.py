...
cfg = Config.fromfile('/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/config_files/faster_rcnn_x101_64x4d_fpn_mstrain_3x_coco.py')
...
cfg.model.roi_head.bbox_head.num_classes = 162
...
#cfg.load_from = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/Model_checkpoints/faster_rcnn_x101_64x4d_fpn_mstrain_3x_coco_20210524_124528-26c63de6.pth'
cfg.load_from = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/checkpoints_FRCNN/epoch_10.pth'

# Set up working dir to save files and logs
cfg.work_dir = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/checkpoints_FRCNN/'
