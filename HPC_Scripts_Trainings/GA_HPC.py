...
cfg = Config.fromfile('/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/config_files/ga_faster_x101_64x4d_fpn_1x_coco.py')
...
#cfg.load_from = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/Model_checkpoints/retinanet_x101_64x4d_fpn_1x_coco_20200130-366f5af1.pth'
cfg.load_from = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/Model_checkpoints/ga_faster_x101_64x4d_fpn_1x_coco_20200215-0fa7bde7.pth'


# Set up working dir to save files and logs
cfg.work_dir = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/checkpoints_ga/'
