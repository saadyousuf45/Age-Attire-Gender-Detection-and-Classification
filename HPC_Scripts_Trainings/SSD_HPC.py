...
#
cfg = Config.fromfile('/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/config_files/ssd512_coco.py')
...
cfg.data.train.dataset.type = 'RepeatDataset'
cfg.data.train.dataset.type = 'NewDataset'
cfg.data.train.data_root = 'data/'
cfg.data.train.dataset.ann_file = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/data/train.txt'
cfg.data.train.dataset.img_prefix = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/Final_images_annotations/Images/'
...
cfg.load_from = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/checkpoints_SSD/epoch_71.pth'

# Set up working dir to save files and logs
cfg.work_dir = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/checkpoints_SSD/'
...
cfg.custom_hooks = [
    dict(type='NumClassCheckHook'),
    dict(type='CheckInvalidLossHook', interval=1000, priority='VERY_LOW')
]
'''
#trying to remove custom hook check
cfg.custom_hooks.type.interval = 1000
'''
