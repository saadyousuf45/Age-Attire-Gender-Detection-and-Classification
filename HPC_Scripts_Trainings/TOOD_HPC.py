...
#
cfg = Config.fromfile('/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/config_files/tood_r101_fpn_dconv_c3-c5_mstrain_2x_coco.py')
...
cfg.load_from = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/Model_checkpoints/tood_r101_fpn_dconv_c3-c5_mstrain_2x_coco_20211210_213728-4a824142.pth'

# Set up working dir to save files and logs
cfg.work_dir = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/checkpoints_TOOD/'
