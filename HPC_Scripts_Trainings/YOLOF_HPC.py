...
#
cfg = Config.fromfile('/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/config_files/yolof_r50_c5_8x8_1x_coco.py')
...
cfg.load_from = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/checkpoints_YOLOF/epoch_250.pth'

# Set up working dir to save files and logs
cfg.work_dir = '/project/RDS-FEI-Age_saad_matloob-RW/HPC_codes/checkpoints_YOLOF/'
